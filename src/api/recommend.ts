...
export const getRecommendPlaylists = () => {
    return http.get<Result<Playlist.PlaylistInfo[]>>(`/recommend/playlist/all`, {timeout:120000});
}
export const getRecommendAutoPlaylists = () => {
    return http.get<Result<Playlist.PlaylistInfo[]>>(`/recommend/playlist/auto/all`, {timeout:120000});
}

export const getHotSongs = () => {
  return http.get<Result<Song.SongContent[]>>('/recommend/hot-songs', {timeout:120000})
}